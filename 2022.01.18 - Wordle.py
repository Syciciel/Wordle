...
appearance_numbers = {'a': 0,
                      ...
                      'x': 0,
                      'y': 0,
                      'z': 0, } #dictionary storing for every letter number of its appearances in a set containing every 5-letter english word
...
'''creating a list of every five letter word'''
five_letter_words = []
...
'''counting appearances in words for every letter - appearance counted only as a 0 or 1, repetitions irrelevant'''
...
'''sorting by appearances, descending and then printing'''
...
'''function which for top10 letters finds out their appearances in every position form 1st to 5th'''
letters = ['a', 'e', 's','r', 'i', 'o', 'l', 't', 'n', 'u']
...
'''function which prints appearances by position in a word '''
...
def plotting_appearances_by_position(letters, five_letter_words):
    ...
    ax.set_title('Appearances by position in a word\n(BTW overall appearances: a=7247, e=6728, s=5871, r=4864, i=4767, o=4613, l=3923, t=3866, n=3773, u=3241)')
...
'''function which prints which letter is most likely to be in a word with a given letter'''
